    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active " href="{{url('/addemp')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
@section('content')
	...
	<div class=" edtform container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="{{url('/insert')}}" method="post">
            @csrf
            @if ($errors->any())
            ...
            <span aria-hidden="true">&times;</span>
             ...
             @endif
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input style="box-shadow: none;" class="input100" type="text" required name="FullNameEmp" placeholder="nom complet">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Email</span>
					<input style="box-shadow: none;" class="input100" type="email" required name="Login"  placeholder="adresse email">
					<span class="focus-input100"></span>
				</div>
